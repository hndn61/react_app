...
export default class EventStringifyParse extends Component {
  ...
  objectToString() {
    ...
    console.log(obj)
    //JSON.stringify():Bir nesneyi json formatlı bir stringe dönüştürmeye yardımcı olur.
  ...
  stringToObject(){
    ...
    //JSON.parse():Json formatındaki bir stringi ayrıştırarak nesneye dönüştürmeye yardımcı olur.
